...
typedef SWIFT_ENUM(NSInteger, LivenessAction, open) {
  ...
  LivenessActionCheckAction = 10,
  LivenessActionProcessing = 11,
};
...
- (UIImage * _Nullable)convertImageToThermalImageWithFrame:(ARFrame * _Nonnull)frame frame_image:(CGRect)frame_image current_frame:(CGRect)current_frame SWIFT_WARN_UNUSED_RESULT;
...
typedef SWIFT_ENUM(NSInteger, LivenessError, open) {
  ...
  LivenessErrorNotSupported = 7,
/// device has no truedepth camera
  LivenessErrorArSessionFailed = 8,
};
...
- (void)setupWithAppId:(NSString * _Nonnull)appId logLevel:(enum LogLevel)logLevel url:(NSString * _Nonnull)url publicKey:(NSString * _Nonnull)publicKey privateKey:(NSString * _Nonnull)privateKey deviceId:(NSString * _Nonnull)deviceId;
